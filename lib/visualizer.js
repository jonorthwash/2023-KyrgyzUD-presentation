...
var Visualizer = (function($, window, undefined) {
    ...
    var Visualizer = function(dispatcher, svgId, webFontURLs,
      ...
      var arcSlant = 15; //10;
      var minArcSlant = 8;
      var arcHorizontalSpacing = 15; // min space boxes with connecting arc
...
Util.profileStart('rows');
        ...
        $.each(rows, function(rowId, row) {
          ...
          if (row.sentence) {
            ...
            // hard-coding 30, 30 puts it at top right corner (at this scale) - JNW 2023-09-07
            var text = svg.text(link, 30, 30, // sentNumMargin - Configuration.visual.margin.x, y - rowPadding,
...
Util.profileStart('finish');
			...
			// this bar is ugly and doesn't work at this scale -JNW 2023-09-07
